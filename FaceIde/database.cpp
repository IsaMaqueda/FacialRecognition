...
void Database::ErrorHandling(long long &flag)

{

	if (flag & ERROR_1_MODULE_4)

	{
		cout << "Creation of N.txt file to count database registries was unsuccesful." << endl;
	}
	else if (flag & ERROR_2_MODULE_4)
	{
		cout << "PersonInfoFile was unable to open." << endl;
	}
	else if (flag & ERROR_3_MODULE_4)
	{
		cout << "FeaturesFile was unable to open." << endl;
	}
	else if (flag & ERROR_4_MODULE_4) {
		cout << "Provided credentials for PersonInfoFile are wrong. Unable to save info. Please verify and retry." << endl;
	}
	else if (flag & ERROR_5_MODULE_4) {
		cout << "PersonInfoFile was unable to open to write & save. Operation cancelled." << endl;
	}
	else if (flag & ERROR_6_MODULE_4) {
		cout << "FeaturesFile was unable to open to write & save. Operation cancelled." << endl;
	}
	else if (flag & ERROR_7_MODULE_4) {
		cout << "Unable to open and read N file. Operation cancelled." << endl;
	}
	else if (flag & ERROR_8_MODULE_4) {
		cout << "Unable to open and update N file. Operation cancelled." << endl;
	}
}